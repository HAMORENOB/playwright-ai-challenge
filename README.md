...
Confirmar que el modelo exista:
...
Ejecutar los comandos desde la raíz del proyecto y confirmar que playwright.config.ts contiene:
...
Revisar el archivo y la línea indicados por el compilador.

### El reporte Allure no muestra la ejecución reciente

Eliminar allure-results y allure-report, volver a ejecutar las pruebas y generar nuevamente el reporte.
